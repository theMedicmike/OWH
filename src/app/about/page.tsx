      ...
      <div className="mx-auto max-w-2xl">
        ...
        <ul className="mt-2 space-y-2 text-sm text-muted">
          {[
            ...
            "Opens that packet with every contention laid out at a glance — when it began, who diagnosed it, how it connects, what is still missing — so a Veterans Service Officer can read the whole picture in a minute instead of assembling it by hand.",
            "Prints a veteran's own account of an injury, and the dated notes they kept about what they noticed since, because for an event-based claim their own words are the evidence.",
