...
insert into known_exposure_sites (name, geom, date_from, date_to, exposure_classes, status, source) values
 ('Joint Base Balad, Iraq (burn pits)',        ST_MakePoint(44.60, 33.90)::geography, '2003-01-01','2011-12-31', '{burn_pit,particulate,heavy_metal}', 'recognized', 'PACT Act / AHOBPR'),
 ...
 ('Da Nang, Vietnam (Agent Orange)',           ST_MakePoint(108.20, 16.05)::geography,'1962-01-01','1975-12-31', '{pesticide,chemical_solvent}',       'recognized', 'Agent Orange registry'),
